...
const char *Token::token_names[27] = {
    ...
    "NUM", "ID", "PRINT", "SEMICOLON", "COMMA", "ASSIGN", "CONDEXP", "IF", "THEN", "ELSE", "ENDIF", "VAR", "WHILE", "DO", "ENDWHILE", "ERR", "END"};
...
VarDec *Parser::parseVarDec()
{
  ...
  tipo = previous->lexema;
  list<string> vars;
  while (match(Token::ID))
  {
    variable = previous->lexema;
